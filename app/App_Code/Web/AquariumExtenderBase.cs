...
namespace MyCompany.Web
{
    ...
    public class AquariumExtenderBase : ExtenderControl
    {
        ...
        public static void RegisterFrameworkSettings(Page p)
        {
            ...
            {
                p.ClientScript.RegisterStartupScript(typeof(AquariumExtenderBase), "TargetFramework", string.Format("var __targetFramework=\"4.8\",__tf=4.0,__servicePath=\"{0}\",__baseUrl=\"{1}\";", p.ResolveUrl(AquariumExtenderBase.DefaultServicePath), p.ResolveUrl("~")), true);
