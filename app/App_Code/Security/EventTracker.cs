...
namespace MyCompany.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("ModifiedBy", RegexOptions.IgnoreCase);

        private static Regex _modifiedByUserIdRegex = null;

        private static Regex _modifiedOnRegex = new Regex("ModifiedOn", RegexOptions.IgnoreCase);
