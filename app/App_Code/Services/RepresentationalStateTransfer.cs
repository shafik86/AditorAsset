            ...
            if (isSaaS)
            {
                if (ApplicationServices.IsTouchClient)
                    ...
                    sb.AppendFormat(string.Format("$(\'<link></link>\').appendTo($(\'head\')).attr({{ href: \'{0}/App_Themes/MyCompany/_T" +
                                "heme_Convention.css?{0}\', type: \'text/css\', rel: \'stylesheet\' }});", ApplicationServices.Version), baseUrl);
                try
                {
                ...
                sb.AppendFormat("var __targetFramework=\'4.8\';__tf=4.0;__cothost=\'appfactory\';__appInfo=\'AditorAsse" +
                        "t|{0}\';", BusinessRules.JavaScriptString(context.User.Identity.Name));
