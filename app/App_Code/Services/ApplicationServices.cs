        ...
        public static string ValidationKey
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(key) || key.Contains("AutoGenerate"))
                    key = "AC1FA43018AF0293C92F5BFE05AD9CECB69A534EE1BE978815BBCC8BFC2D556C06C2BC659864CFD7E" +
                        "C140D692EF5E0B845CA7FFFF24EBD3E88E8083ADA93C9D7";
                return key;
            }
        }
                ...
                if (_defaultSettings == null)
                {
                    ...
                    if (_defaultSettings == null)
                    {
                        ...
                        if (_defaultSettings == null)
                        {
                            ...
                            EnsureJsonProperty(ui, "theme.accent", "Convention");
